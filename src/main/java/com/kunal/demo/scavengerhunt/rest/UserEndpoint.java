...
public class UserEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<User> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.userGroup WHERE u.id = :entityId ORDER BY u.id",
						User.class);
	...
	public List<User> listAll() {
		final List<User> results = em
				.createQuery(
						"SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.userGroup ORDER BY u.id",
