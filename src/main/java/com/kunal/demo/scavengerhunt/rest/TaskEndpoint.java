...
public class TaskEndpoint
{
   ...
   {
      TypedQuery<Task> findByIdQuery = em.createQuery("SELECT DISTINCT t FROM Task t LEFT JOIN FETCH t.owner WHERE t.id = :entityId ORDER BY t.id", Task.class);
   ...
   {
      final List<Task> results = em.createQuery("SELECT DISTINCT t FROM Task t LEFT JOIN FETCH t.owner ORDER BY t.id", Task.class).getResultList();
      return results;
   }
